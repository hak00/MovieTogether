		...
		<div class="container">
			<table class="type09">
				<tbody>
					<tr>
						<th scope="row">이름</th>
						<td class="td1"><input type="text" name="name" id="input2" value="<%=name%>"></td>
					</tr>
					<tr>
					...
					<tr>
						<th scope="row">제목</th>
						<td><input type="text" name="subject" id="input2" value="<%=subject%>"></td>
					</tr>
					<tr>
						<th scope="row">내용</th>
						<td><textarea name="content" rows="13" cols="150"><%=content%></textarea></td>
					</tr>
				</tbody>
			</table>
			<div class="searchBox">
